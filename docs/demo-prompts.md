...
navigation to it, and the latest time I must leave for the airport. Keep a note
of which stops I actually reached.
```
...
## What neither prompt says

Neither mentions `intent`, `calendar`, a bundle name or a parameter. The model
